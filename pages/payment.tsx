import { FormControl, Radio, FormControlLabel, List, ListItem, RadioGroup, Typography, Button } from '@material-ui/core';
...
export default function Payment() {
    ...
    const submitHandler = (e: any) => {
        ...
        e.preventDefault();
        if(!paymentMethod){
            snackbar.enqueueSnackbar('Payment Method is required', {variant: 'error'});
        } else {
            ...
            <List>
                <ListItem>
                    <FormControl component="fieldset">
                        <RadioGroup aria-label="Pamyent Method" 
